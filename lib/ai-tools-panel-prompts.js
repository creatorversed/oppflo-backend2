...
[2-3 sentences placing this opportunity in creator economy hiring history. For posts from 2022+ be specific about platform shifts, market conditions, or industry events from that period. For pre-2022 posts keep era context general. Read like a brief industry memo from that moment.]
</div>

<div class="ims-section ims-signal">
<h3>📊 Opportunity Signal</h3>
[Apply SMALL-NUMBER CREDIBILITY and ROLE FAMILY INTELLIGENCE. If exact_signal_count is high (20+) call it "strong sustained demand". If medium (5-19) call it "consistent demand". If low (1-4) do NOT open with the count — lead with role family context from query_role_family, then mention the exact count as a note about title standardization. If exact_signal_count is under 10, include the EMERGING INDUSTRY ACKNOWLEDGMENT sentence verbatim with the real number substituted.]
</div>

<div class="ims-section ims-salary">
<h3>💰 Salary Intelligence</h3>
[Use avg_salary_min and avg_salary_max from query_a_signal_frequency when available. If exact salary data is missing or sparse, reference the averages from query_role_family instead and say so clearly. Compare to the salary at time of posting if provided. Note any shifts. Flag if signals appear to skew pre-2023 and explain ranges may have shifted. If no salary data is available at all, state directly that this role type historically did not disclose compensation publicly — and treat that opacity itself as a market signal.]
</div>

<div class="ims-section ims-repost">
<h3>🔄 Repost Signal</h3>
[Use company_signal_count and first_company_post/last_company_post from query_b_company_signals.
...
- If 20+, quantify confidently.
Include ONE employer-facing insight: what the pattern reveals about this company's creator economy strategy for someone doing competitive intelligence. Observations must be uniquely true of this company — reference specific time span and signal pattern, never phrasing that could apply to any company.]
</div>

<div class="ims-section ims-career">
<h3>🚀 Career Path Context</h3>
[Write as a senior recruiter giving advice to a peer. What roles typically lead into this opportunity. What roles this opportunity leads to next. Include 2-3 specific role titles in the progression chain. Targets creator economy careers and influencer marketing careers search intent.]
</div>

<div class="ims-section ims-skills">
<h3>🎯 Skills Intelligence</h3>
[Market-analyst briefing tone — specific, opinionated, forward-looking. Top 5 skills this opportunity required based on the role function. For each skill: Growing Demand / Stable Demand / Shifting — based on current creator economy market conditions in 2026.]
</div>

<div class="ims-section ims-related">
<h3>🔗 Related Opportunities in the IMS Archive</h3>
[List up to 5 similar opportunities from query_c_similar_recent_roles results. Format each as: Role Title at Company — Location (Year). These are real IMS archive records.]
</div>

<div class="ims-section ims-verified">
<h3>✅ IMS x CREATORVERSED Verified</h3>
<p>This opportunity has been hand-curated and verified by Influencer Marketing Society (IMS) and CREATORVERSED as a legitimate role in the creator economy. IMS has maintained the industry's most complete creator economy career archive since 2016 — 22,000+ opportunity signals tracked, zero ghost opportunities, always. Every opportunity is hand-reviewed by the IMS team before being added to the archive — a standard maintained since 2016.</p>
